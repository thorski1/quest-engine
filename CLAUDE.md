...
## What This Is
Quest Engine is a pluggable educational game engine. It powers 6 games with 101 chapters and 4,811+ challenges.
...
- **Tests**: 79 tests in `tests/`, run with `python3 -m pytest tests/ -v`
